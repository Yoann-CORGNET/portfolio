const experiences = [
  {
    ...
    description:
      "Recherche active d'une opportunité pour approfondir mes compétences en développement backend",
  ...
  },
  {
    ...
    description:
      "Formation en génie logiciel avec spécialisation en développement backend et architecture",
          ...
          <div className="space-y-8">
            {experiences.map((exp, index) => (
              ...
              >
                ...
                {/* Content */}
                <div
                  className={`flex-1 ml-10 md:ml-0 ${index % 2 === 0 ? "md:pr-12" : "md:pl-12"}`}
                >
